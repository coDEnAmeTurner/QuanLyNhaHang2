...
public class HoaDon {
    ...
    public double tinhTongTien(){
        return this.buaTiec.getGiaThueSanh() + this.buaTiec.tinhGiaDVu() + this.buaTiec.tinhGiaMenu();
    }
    public void xuatHoaDon(){
        ...
        System.out.printf("|Ngày thuê:%s|",CauHinh.f.format(this.buaTiec.getNgayThue()));
